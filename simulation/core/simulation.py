...
class Simulation(object):
    def __init__(
        ...
        self.used_workers_id = set()  # tracking purpose
    ...
    def run_finish(self, last_time, by_job_type=False):
        ...
        print_end_jobs(last_time, completed_jobs, self.jobs, self.used_workers_id)
    ...
    def produce_time_breakdown_results(self, completed_jobs):
        ...
        for index, completed_job in enumerate(completed_jobs):
            ...
            job_creation_interval = DEFAULT_JOB_CREATION_INTERVAL
